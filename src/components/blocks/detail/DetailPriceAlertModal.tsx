 ...
 * Modal for subscribing to price drop alerts.
 * Options: email, Google sign-in, or email+password login.
 */

import React, { useState } from "react";
import { Dialog, DialogContent, DialogTitle } from "@/components/ui/dialog";
import { BellRing, Mail, X, Eye, EyeOff } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[420px] p-0 border-none bg-white overflow-hidden gap-0">
        ...
        {submitted ? (
          ...
          <div className="px-6 py-10 text-center">
            ...
            <button
              onClick={handleClose}
              className="mt-6 text-[12px] tracking-[0.08em] uppercase text-neutral-500 hover:text-neutral-800 font-medium transition-colors"
            >
              Cerrar
            </button>
          </div>
            ...
            {mode === "email" ? (
              <>
                ...
                <form onSubmit={handleSubmitEmail} className="space-y-3">
                  <div>
                    <label className="text-[11px] tracking-[0.08em] uppercase text-neutral-500 font-medium mb-1.5 block">
                      Email
                    </label>
                    <input
                      type="email"
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 bg-neutral-900 text-white text-[12px] tracking-[0.1em] uppercase py-3.5 hover:bg-neutral-800 transition-all font-medium"
                  >
                ...
                <button
                  ...
                  className="w-full text-center text-[12px] text-neutral-400 hover:text-neutral-600 font-light mt-4 transition-colors"
                >
