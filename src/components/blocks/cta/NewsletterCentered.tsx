        ...
        <div className="max-w-xl mx-auto px-5 sm:px-6 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3" onSubmit={handleSubmit}>
            <input
              ...
              className="flex-1 px-5 py-4 text-sm tracking-[0.05em] focus:outline-none transition-colors duration-300 border border-neutral-200 bg-white text-neutral-900"
              required
            />
