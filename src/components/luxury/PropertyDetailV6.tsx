          ...
          <aside className="lg:col-span-5 lg:self-start">
            <div className="lg:sticky lg:top-[84px] lg:max-h-[calc(100vh-96px)] lg:overflow-y-auto bg-neutral-50 border border-neutral-200 rounded-sm p-6" itemProp="offers" itemScope itemType="https://schema.org/Offer">
              ...
              <div className="border-t border-neutral-200 pt-5">
                ...
                <button className="group flex items-center justify-center gap-1.5 text-[11px] tracking-[0.06em] text-luxury-gold/80 hover:text-luxury-gold font-light transition-colors mt-3 mx-auto">
                  <BellRing className="w-3 h-3 group-hover:animate-[wiggle_0.4s_ease-in-out]" strokeWidth={1.4} />
                  Avísame si baja el precio
                </button>
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="relative z-10 text-center px-6 max-w-lg">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                    ...
                    <button onClick={() => setEnquiryOpen(true)} className="w-full sm:w-auto flex items-center justify-center gap-2 border border-white/30 text-white text-[12px] tracking-[0.1em] uppercase px-8 py-3 hover:bg-white/10 transition-all">
