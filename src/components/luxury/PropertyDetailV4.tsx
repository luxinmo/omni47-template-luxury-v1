...
import {
  ...
  Play, View, FileDown, Home, Shield, Sparkles, Clock, Grid3X3,
} from "lucide-react";
  ...
  return (
    <div className="flex-1 overflow-auto bg-white text-luxury-black font-sans">
      ...
      <main className="max-w-[1400px] mx-auto px-6 lg:px-10 py-8">
        ...
        {/* ─── SUMMARY CARD (from V2) ─── */}
        <div className="bg-neutral-50 border border-neutral-200 rounded-sm p-6 lg:p-8 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex items-center gap-7">
                {[
                  ...
                  { label: "Built", value: `${p.sqm} m²` },
                  { label: "Plot", value: `${p.plot.toLocaleString()} m²` },
                  { label: "Garage", value: p.garage },
                ].map((s, i) => (
                  <div key={i} className="text-center">
                    <p className="text-[12px] tracking-[0.1em] uppercase text-luxury-black/50 mb-0.5">{s.label}</p>
                    <p className="text-[16px] text-luxury-black font-light">{s.value}</p>
                  </div>
                ))}
              </div>
            ...
            <div className="lg:col-span-5 flex flex-col justify-between">
              <div>
                ...
                {p.alsoForRent && (
                  <p className="text-[13px] text-luxury-black/50 mb-6 flex items-center gap-1.5">
              ...
              <div className="flex gap-2">
                ...
                <button className="flex-1 flex items-center justify-center gap-2 border border-neutral-300 text-luxury-black text-[12px] tracking-[0.1em] uppercase py-3 hover:bg-neutral-100 transition-all">
        ...
        {/* ─── BODY: DESCRIPTION + SIDEBAR (from V2) ─── */}
      ...
      {/* ─── SIMILAR PROPERTIES (listing card style from V2) ─── */}
