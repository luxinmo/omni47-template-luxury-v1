          ...
          <div className="flex items-center gap-2">
            ...
            <Popover>
              ...
              <PopoverContent align="end" className="w-[180px] p-0 rounded-none border-luxury-black/10">
                <Link to="/pdf-v1" target="_blank" className="block px-4 py-3 text-[11px] tracking-wider text-luxury-black hover:bg-luxury-sand/50 transition-colors">
                  FICHA (1 PAGE)
                </Link>
                <Link to="/pdf-v2" target="_blank" className="block px-4 py-3 text-[11px] tracking-wider text-luxury-black hover:bg-luxury-sand/50 transition-colors border-t border-luxury-black/5">
                  CATÁLOGO (3 PAGES)
                </Link>
              </PopoverContent>
            </Popover>
