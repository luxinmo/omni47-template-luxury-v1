...
export default function AboutPageV5() {
  ...
  return (
    <Layout showNavbar showFooter navVariant="transparent">
      ...
      >
        {/* Background image — warm sunset villa */}
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=1920&q=80"
            alt="Luxury villa at sunset"
            className="w-full h-full object-cover"
            style={{ opacity: 0.45, filter: "brightness(0.7) saturate(0.9)" }}
          />
          <div
            className="absolute inset-0"
            style={{
              background: `linear-gradient(180deg, ${elite.black}99 0%, ${elite.black}55 50%, ${elite.black}BB 100%)`,
            }}
          />
        </div>
