...
import { MapPin, Phone, Mail, Clock, Instagram, Linkedin, Facebook, Twitter, ChevronUp, Send, Check, ArrowRight } from "lucide-react";
...
const ContactPage = () => {
  ...
  return (
    <div ref={containerRef} className="flex-1 overflow-auto" style={{ background: p.white, color: p.text, fontFamily: font }}>
      ...
      <section className="max-w-[1200px] mx-auto px-5 sm:px-6 py-14 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 lg:gap-16">

          {/* ─── CONTACT FORM ─── */}
          <div>
            <p className="text-[10px] tracking-[0.2em] uppercase font-medium mb-3" style={{ color: p.accent }}>Send a Message</p>
            <h2 className="text-[24px] md:text-[30px] font-extralight tracking-[0.02em] mb-2">How Can We Help?</h2>
            <p className="text-[13px] font-light mb-8" style={{ color: p.muted }}>Select one or more offices and fill in the form below. We typically respond within 24 hours.</p>

            {/* Office selector */}
            <div className="mb-8">
              <label className="block text-[11px] tracking-[0.1em] uppercase font-medium mb-3" style={{ color: p.muted }}>Select Office(s)</label>
                ...
                {OFFICES.map((o) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2.5 text-[12px] tracking-[0.08em] font-light transition-all duration-300"
                      style={{
                        border: `1px solid ${selected ? p.text : p.border}`,
                        background: selected ? p.text : "transparent",
            ...
            {submitted ? (
              <div className="py-16 text-center" style={{ background: p.bg }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{ border: `1px solid ${p.border}`, background: p.white, color: formSubject ? p.text : p.light }}
                    >
                ...
                <div>
                  ...
                  <textarea
                    value={formMessage} onChange={(e) => setFormMessage(e.target.value)} required
                    placeholder="Tell us about your requirements, preferred locations, budget range..."
                    rows={5}
                ...
                <p className="text-[11px] font-light" style={{ color: p.light }}>
          ...
          <aside className="space-y-6">
            <p className="text-[10px] tracking-[0.2em] uppercase font-medium" style={{ color: p.accent }}>Our Offices</p>
            ...
            {OFFICES.map((office) => (
              <div
                ...
                style={{
                  border: `1px solid ${selectedOffices.includes(office.id) ? p.accent : p.border}`,
                  background: selectedOffices.includes(office.id) ? p.bg : p.white,
                }}
              >
                {/* Image */}
                <div className="relative overflow-hidden aspect-[16/8]">
                  ...
                  <div className="absolute bottom-3 left-4">
                    <h3 className="text-[15px] font-light tracking-[0.04em]" style={{ color: p.white }}>{office.name}</h3>
