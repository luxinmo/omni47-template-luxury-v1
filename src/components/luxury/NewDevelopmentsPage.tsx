...
import { Building2, MapPin, ArrowRight, TrendingUp, CalendarDays, Home, CheckCircle, Shield } from "lucide-react";
      ...
      <div className="flex-1 p-6 lg:p-8 flex flex-col">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 text-[10px] tracking-[0.1em] uppercase rounded-sm border" style={{ borderColor: palette.border, color: palette.textMuted }}>New Build</span>
          </div>
        ...
        <p className="text-[13px] font-light mb-4" style={{ color: palette.textMuted }}>
          {d.developer} · Delivery {d.delivery}
        </p>
  ...
  return (
    <Layout navVariant="transparent" activePath="/" showBackToTop={false}>
      <SEOHead
        ...
        description="Discover new-build homes and off-plan properties across Costa Blanca, Ibiza and Marbella. Buy at pre-construction prices with payment plans and bank-guaranteed deposits."
      />
        ...
        <div className="max-w-[1000px] mx-auto px-5 sm:px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extralight mb-8" style={{ fontFamily: fonts.heading, letterSpacing: "0.04em" }}>Why Buy New Build in Spain?</h2>
            </div>
          </FadeIn>
          <FadeIn delay={0.1}>
            <div className="space-y-6 text-[15px] leading-[1.9] font-light" style={{ color: palette.textMuted }}>
              <p>
                New-build properties in Spain represent one of the smartest investments in the Mediterranean real estate market. Buying off-plan — before or during construction — allows you to secure a home at pre-construction prices, typically <strong style={{ color: palette.text }}>20–30% below</strong> the value of the completed property at handover.
              </p>
              <p>
                Spanish law provides robust consumer protection for off-plan buyers. Developers are required to provide bank guarantees on all deposits, ensuring your money is protected even if the project is delayed or cancelled. Payment plans are typically structured over the construction period, with 30% paid during the build and 70% upon completion.
              </p>
              <p>
                Modern new-build homes meet the latest energy efficiency standards, feature contemporary design and smart home technology, and come with full manufacturer warranties. Many developments include resort-style amenities such as communal pools, landscaped gardens, gymnasiums, co-working spaces and concierge services.
              </p>
            </div>
          </FadeIn>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extralight" style={{ fontFamily: fonts.heading, letterSpacing: "0.04em" }}>The New Build Advantage</h2>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-[14px] font-light mt-4 max-w-2xl mx-auto" style={{ color: palette.textMuted }}>
                Explore our curated selection of new-build projects across Spain's most sought-after coastal destinations.
              </p>
            </div>
          </FadeIn>
          <div className="space-y-6">
            {NEW_DEVELOPMENTS.map((d, i) => (
              <DevCard key={i} d={d} i={i} />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[800px] mx-auto px-5 text-center">
          <FadeIn>
            ...
            <p className="text-[15px] leading-[1.9] font-light mb-10" style={{ color: "rgba(255,255,255,0.55)" }}>
              Contact our specialist team for private viewings, floor plans, payment schedules and exclusive pre-launch access to new-build projects across Spain.
            </p>
